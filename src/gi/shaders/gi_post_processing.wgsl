...
@group(0) @binding(0) var in_floor_texture:              texture_2d<f32>;
@group(0) @binding(1) var in_floor_sampler:              sampler;
@group(0) @binding(2) var in_walls_texture:              texture_2d<f32>;
@group(0) @binding(3) var in_walls_sampler:              sampler;
@group(0) @binding(4) var in_objects_texture:            texture_2d<f32>;
@group(0) @binding(5) var in_objects_sampler:            sampler;
@group(0) @binding(6) var in_irradiance_texture:         texture_2d<f32>;
@group(0) @binding(7) var in_irradiance_texture_sampler: sampler;
